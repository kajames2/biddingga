#ifndef AUCTIONS_COMMON_VALUE_ENDPOINTS_H_
#define AUCTIONS_COMMON_VALUE_ENDPOINTS_H_
...
class CommonValueEndpoints {
 public:
  CommonValueEndpoints(int n_bidders,
...
#endif  // AUCTIONS_COMMON_VALUE_ENDPOINTS_H_
